...
def main():
    ...
    # Variables for "on" message logic
    ...
    # Variables for data statistics
    last_send_data_time = 0
    send_data_delay = 0.2  # Delay time in seconds
    ...
    while True:
        ...
        # Send data statistics every 0.2 seconds
        if time.time() - last_send_data_time >= send_data_delay:
            confidence_mean = (confidence_sum / detected_count) if detected_count > 0 else 0.0
